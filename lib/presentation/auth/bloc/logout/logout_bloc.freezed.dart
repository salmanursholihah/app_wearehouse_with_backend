...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  submit,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  submit,}) {final _that = this;
switch (_that) {
case _Submit():
return submit();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  submit,}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit();case _:
  return null;
...
class _Submit implements LogoutEvent {
  const _Submit();
