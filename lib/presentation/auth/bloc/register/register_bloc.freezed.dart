...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String name,  String email,  String password)?  submit,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit(_that.name,_that.email,_that.password);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String name,  String email,  String password)  submit,}) {final _that = this;
switch (_that) {
case _Submit():
return submit(_that.name,_that.email,_that.password);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String name,  String email,  String password)?  submit,}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit(_that.name,_that.email,_that.password);case _:
  return null;
...
class _Submit implements RegisterEvent {
  const _Submit({required this.name, required this.email, required this.password});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Submit&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password));
}
...
@override
String toString() {
  return 'RegisterEvent.submit(name: $name, email: $email, password: $password)';
}
...
/// @nodoc
abstract mixin class _$SubmitCopyWith<$Res> implements $RegisterEventCopyWith<$Res> {
